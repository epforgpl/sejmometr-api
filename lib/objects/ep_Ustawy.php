 ...
 *
 * @package Objects\ep_Ustawy
 * @version 0.1 alpha build 99
 * @author Sejmometr REST API lib Generator 1.0 <biuro@epf.org.pl>
 * @link sejmometr.pl
 *
 * @method ep_Ustawy cleanFilters()
 * @method ep_Ustawy cleanQueryString()
 * @method ep_Ustawy cleanSort()
 * @method ep_Ustawy cleanResponseType()
 * @method ep_Ustawy cleanLimit()
 * @method ep_Ustawy cleanPage()
 */

class ep_Ustawy extends ep_Dataset
{
	/** 
	 * Data publikacji
	 * 
    ...
    public function getObjects()
    {
        ...
        foreach ($objects as $object) {
            if (isset($object['data'])) {
                array_push($this->objects, new ep_Ustawa($object));
            }
        }
        return $this->objects;
    }
